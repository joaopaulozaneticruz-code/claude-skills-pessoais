...
*(Nota de roteamento — 16/08/2026: este é o "Slide System" mais robusto
entre as três implementações de slides do ambiente — os outros são o bloco
embutido na skill `design` e a skill standalone `slides`, ambos mais
diretos. Use este quando a apresentação precisa seguir `brand-guidelines.md`
à risca — é o único dos três com validação de conformidade de token
(`slide-token-validator.py`) e busca BM25 contextual por estratégia/emoção.)*
