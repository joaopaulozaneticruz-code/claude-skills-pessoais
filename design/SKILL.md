...
*(Nota de roteamento — 16/08/2026: esta skill delega pra fora em 3 casos
(brand, design-system, ui-styling) mas duplica internamente em outros
(banner, slides, logo, CIP, ícones) — sem critério documentado pra essa
diferença; provavelmente porque brand/design-system/ui-styling já existiam
como skills maduras quando esta foi empacotada, e as demais não. Onde há
duplicata, as versões standalone (`banner-design`, `slides`) e o "Slide
System" da `design-system` têm sua própria nota de roteamento explicando
quando preferir qual — os blocos "Built-in" abaixo continuam valendo pra
quando você já está dentro do fluxo desta skill.)*
