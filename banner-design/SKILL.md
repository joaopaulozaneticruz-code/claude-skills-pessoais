...
*(Nota de roteamento — 16/08/2026: a skill `design` tem um bloco "Banner
Design" embutido com as mesmas tabelas de tamanho/estilo desta skill —
dispara quando você já está dentro do fluxo unificado dela, ex: pedindo
banner junto de logo/CIP/social photos no mesmo pedido. Fora desse
contexto — um pedido de banner isolado — esta skill standalone serve
direto, sem passar pelo roteamento da `design`.)*
