...
*(Nota de roteamento — 16/08/2026: "thought leader ads" também aparece no
gatilho da skill `ads` com outro sentido — lá é o formato de anúncio pago
que impulsiona um post orgânico já existente (ex: LinkedIn Thought Leader
Ads). Aqui é sobre encontrar/remunerar a pessoa como criadora. Pedido de
"promover este post como anúncio" → `ads`; "encontrar/pagar um thought
leader" → aqui.)*
